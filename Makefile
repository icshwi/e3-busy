...
# Author  : jhlee
# email   : @esss.se
# Date    : generated by 2017Nov19-2021-39CET
# version : 0.0.0 
#
# template file is generated by prepare_module.bash with 31a08c5adebebd6cdf7bf676b8f10eae8c20f176
#
...
#       no RELEASE.local in iocStats
	...
	$(QUIET)echo "INSTALL_LOCATION=$(M_BUSY)"               > $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/CONFIG_SITE	
...
.PHONY: env $(E3_ENV_NAME) $(EPICS_MODULE_NAME) git-submodule-sync init help help2 build clean install uninstall conf rebuild epics epics-clean checkout
